          ...
          <div className="flex justify-around">
            ...
            <div className="flex flex-col space-y-3">
              ...
              <div className="flex space-x-4 items-center">
                ...
                <a className="hover:font-semibold text-white no-underline" href="tel:+84775509168">
                  0775509168
                </a>
              </div>
              <div className="flex space-x-4 items-center">
                ...
                <a  className="hover:font-semibold text-white no-underline" href="https://mail.google.com/mail/?view=cm&fs=1&to=minhtriet17101@gmail.com" target="_blank" rel="noreferrer">
